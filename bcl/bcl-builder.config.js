...
module.exports = {
  ...
  colorScheme: [
    {
      entry: path.resolve(__dirname, "src/scss/color-scheme-variables.scss"),
      dest: path.resolve(outputFolder, "css/color-scheme.min.css"),
      options: {
        includePaths,
        minify: true,
        sourceMap: "file",
        importsFile: path.resolve(__dirname, "src/scss/color-scheme.scss"),
        generatorFile: path.resolve(__dirname, "src/scss/color_scheme/generator.scss"),
      },
    },
  ],
  styles: [
    {
      entry: path.resolve(__dirname, "src/scss/oe-bcl-default.scss"),
