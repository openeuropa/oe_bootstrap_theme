...
class GalleryItemValueObject extends ValueObjectBase {
   ...
   *
   * @var \Drupal\oe_bootstrap_theme\ValueObject\ImageValueObject
   */
  protected $thumbnail;
   ...
   *
   * @param \Drupal\oe_bootstrap_theme\ValueObject\ImageValueObjectInterface $thumbnail
   ...
   * Getter.
   *
   * @return \Drupal\oe_bootstrap_theme\ValueObject\ImageValueObject
   *   Property value.
   */
